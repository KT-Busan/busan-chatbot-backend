...
class UserHandler:
    ...
    def get_user_info(self, anonymous_id):
        ...
        try:
            ...
            return self._handle_api_error(e, '사용자 정보를 가져오는')
    ...
    def create_user(self, anonymous_id):
        ...
        try:
            ...
            db.session.rollback()
            return self._handle_api_error(e, '사용자 생성')
    ...
    def get_users_stats(self):
        ...
        try:
            ...
            stats = {key: query() for key, query in stats_queries}
            ...
            return self._handle_api_error(e, '사용자 통계를 가져오는')
